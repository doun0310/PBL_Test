...
class SharingService {
  ...
  static String _formatMealText(MealEntry meal) {
    ...
    buffer.writeln('${meal.mealType.displayName} 식사 기록');
    buffer.writeln('');
    ...
    buffer.writeln('');
    buffer.writeln('DIETRAKING 앱으로 기록했습니다');
  ...
  static Future<void> shareDailySummary(
    ...
    buffer.writeln('');
    buffer.writeln('총 ${meals.length}끼 식사');
    buffer.writeln('');
  ...
  static Future<void> shareWeeklySummary(
    ...
    buffer.writeln('');
    buffer.writeln('총 식사: $totalMeals끼');
    ...
    buffer.writeln('');
    buffer.writeln('DIETRAKING 앱으로 꾸준히 관리중!');
  ...
  static Future<void> shareGoalAchievement(
    ...
    buffer.writeln('');
    buffer.writeln('DIETRAKING 앱으로 건강 관리 중!');
  ...
  static Future<void> shareCommunityPost(
    ...
    final buffer = StringBuffer();
    buffer.writeln('갤러리 게시물');
    buffer.writeln('');
    buffer.writeln(title);
    buffer.writeln('');
    buffer.writeln(content);
    buffer.writeln('');
    buffer.writeln('DIETRAKING 갤러리');
