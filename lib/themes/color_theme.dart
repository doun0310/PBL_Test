...
final blueTwo = Color(0xFF96BCF3);
final blueThree = Color(0xFFF3F5F9);
...
final grayThree = Color(0x5CC4C4C4);
final grayFour = Color(0xFF818181);
final grayFive = Color(0xFF747474);
final graySix = Color(0xFFF4F4F4);
final graySeven = Color(0xFF6A6E85);
...
// 그라디언트
final blueLinearGradientOne = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [dalgeurakBlueOne, purpleOne],
);

final purpleGreenLinearGradientOne = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [purpleTwo, greenFour],
);

final greenLinearGradientOne = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [greenFive, greenSix],
);

final pinkLinearGradientOne = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [pinkOne, pinkTwo],
);

final emptyColor = Color(0xFFFFFFFF);
