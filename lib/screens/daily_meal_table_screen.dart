        ...
        child: Column(
          ...
          children: [
            ...
            _buildNutritionRow(
              '탄수화물',
              '${totalCarbs.toInt()} g',
              '목표: ${_userGoals.dailyCarbsGoal.toInt()} g',
              totalCarbs / _userGoals.dailyCarbsGoal,
            ),
            const SizedBox(height: 12),
            _buildNutritionRow(
              '단백질',
              '${totalProtein.toInt()} g',
              '목표: ${_userGoals.dailyProteinGoal.toInt()} g',
              totalProtein / _userGoals.dailyProteinGoal,
            ),
            const SizedBox(height: 12),
            _buildNutritionRow(
              '지방',
              '${totalFat.toInt()} g',
              '목표: ${_userGoals.dailyFatGoal.toInt()} g',
              totalFat / _userGoals.dailyFatGoal,
            ),
          ],
        ),
      ),
